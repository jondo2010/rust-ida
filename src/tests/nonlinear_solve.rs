...
fn test1() {
    ...
    // Set preconditions:
    {
        ...
        let ida_ee = array![ 4.1727139878938076e-11, 2.1149917627362784e-07, -2.1154090341350681e-07, ];
        let ida_ewt = array![ 9.9998973798771240e+03, 9.9637670594659017e+05, 9.9469101754210191e+05, ];
        let ida_yy = array![ 9.9991026211759748e-01, 3.6364700537310025e-05, 5.3373181865225196e-05, ];
        let ida_yp = array![ -3.9977143388587585e-02, 4.0305282775288977e-04, 3.9574090561052919e-02, ];
        let ida_yypredict = array![ 9.9989651717362982e-01, 3.6161601850240890e-05, 6.7321224520057807e-05, ];
        let ida_yppredict = array![ -3.9971798676247110e-02, -1.5843981431024555e-03, 4.1556196819751090e-02, ];
    ...
    {
        let ida_yy = array![9.9989651723441231e-01,3.6526684773526134e-05,6.6956080814055887e-05,];
        let ida_yp = array![-3.9971533515318521e-02,8.2598672507300415e-06,3.9963273647500658e-02,];
        let ida_yypredict = array![9.9989651717362982e-01,3.6161601850240890e-05,6.7321224520057807e-05,];
        let ida_yppredict = array![-3.9971798676247110e-02,-1.5843981431024555e-03,4.1556196819751090e-02,];
        let ida_delta = array![0.0000000000000000e+00,0.0000000000000000e+00,0.0000000000000000e+00,];
        let ida_ee = array![6.0782494622797157e-11,3.6508292328524681e-07,-3.6514370600191418e-07,];
        let ida_ewt = array![9.9998973798771240e+03,9.9637670594659017e+05,9.9469101754210191e+05,];
        let ida_cj=4.3624555101658616e+03;
        let ida_cjold=4.3624555101658616e+03;
        let ida_cjratio=1.0000000000000000e+00;
